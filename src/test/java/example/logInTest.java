...
public class logInTest {
    ...
    @Test
    public void loginInPersonalCabinetButtonTest(){
        driver.get("https://stellarburgers.nomoreparties.site/");
    ...
    public void loginInRegistrationForm(){
        ...
        homePageBurger.clickLittleButtonLogin();
        homePageBurger.logInButtonAccount(EMAIL, PASSWORD);
        By button = homePageBurger.getButtonCreateOrder();
        WebElement element = new WebDriverWait(driver, Duration.ofSeconds(2))
                .until(ExpectedConditions.visibilityOfElementLocated(button));
    ...
    @Test
    public void loginInResstorePassword(){
